...
import com.example.keyadministrator.util.ImageUtil;
...
public class FaceServer {
    ...
    private long getFaceIdNumber;
    private byte[] faceFeatureData;
    private String imageFullPath;
    private long getCompareFaceId;
    /**
     * 最大注册人脸数
     */
    ...
    public boolean registerNv21(Context context, byte[] nv21, int width, int height, FacePreviewInfo faceInfo, String name,
        ...
        if (code != ErrorInfo.MOK) {
            ...
            getFaceIdNumber = faceId;
            faceFeatureData = faceEntity.getFeatureData();
            return true;
        }
    }
    // 返回faceId
    public long getFaceIdNumber() {
        return getFaceIdNumber;
    }
    ...
    private String getImagePath(String name) {
        ...
        imageFullPath = imageRootPath + File.separator + name + "_" + System.currentTimeMillis() + ".jpg";
    ...
    public CompareResult searchFaceFeature(FaceFeature faceFeature, FaceEngine faceEngine) {
        ...
        try {
            ...
            if (searchResult != null) {
                ...
                getCompareFaceId = faceEntity.getFaceId();
                if (faceEntity != null) {
    ...
    // 返回比对后的faceId
    public long getCompareFaceIdNumber() {
        return getCompareFaceId;
    }
