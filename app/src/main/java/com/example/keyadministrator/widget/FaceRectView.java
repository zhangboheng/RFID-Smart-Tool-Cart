...
public class FaceRectView extends View {
    ...
    /**
     * 绘制数据信息到view上，若 {@link com.example.keyadministrator.widget.FaceRectView.DrawInfo#getName()} 不为null则绘制 {@link com.example.keyadministrator.widget.FaceRectView.DrawInfo#getName()}
     *
